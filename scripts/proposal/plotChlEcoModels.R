...
p <- p + geom_line(aes(x=date, y=chl, color='Observations'), df_obs)
...
ggsave('results/proposal/figures/chl_models1.png', p)
...
ggsave('results/proposal/figures/chl_models2.png', p)
...
ggsave('results/proposal/figures/chl_models3.png', p)